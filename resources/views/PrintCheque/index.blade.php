...
<form action="{{route('PrintCheque.index')}}" method="post">
    @csrf
    @method('post')
    <div class="contacts">
        <div class="home">
        ...
        <div class="footer">
            ...
            <div class="mero">
                ...
                <input type="date" name="chequedata" placeholder="Cheque Data " required>
                <label for="">To</label>
                <input type="date" name="tochequedata" placeholder="To Cheque Data" required>
            </div>
            <div class="mero">
                <label for="">iSSUE</label>
                <input type="date" name="issuedata" placeholder="issuedata" required>
                <label for="">To</label>
                <input type="date" name="toissuedata" placeholder="To" required>
            </div>
            <div class="mero">
                <label for="">Print</label>
                <input type="date" name="printdateform" placeholder="printdateform" required>
                <label for="">To</label>
                <input type="date" name="toprintdateform" placeholder="toprintdateform" required>
            </div>
    ...
    <table class="table">
        ...
        @foreach ($mo as $nm )
          <tr>
            ...
            <td>{{$nm->payto}}</td>
            <td>{{$nm->chequedata}}</td>
            <td>{{$nm->tochequedata}}</td>
            <td>{{$nm->issuedata}}</td>
            <td>{{$nm->toissuedata}}</td>
            <td>{{$nm->printdateform}}</td>
            <td>{{$nm->toprintdateform}}</td>
            <td>{{$nm->printstatus}}</td>
            <td>{{$nm->company}}</td>
            <td>
                <form action="{{route('PrintCheque.destroy',$nm->id)}}" method="post">
                    @csrf
                    @method("DELETE")
