...
<form action="{{route('PropertDetailsReport.index')}}" method="post">
    @csrf
    @method('post')
    <div class="contacts">
        <div class="home">
            ...
            <div>
                ...
                <input type="text" name="propeerty" placeholder="Property" required>
            </div>
            <div>
                <!-- <label>Email : </label> -->
    ...
    <table class="table">
        ...
        @foreach ($mo as $nm )
            <tr>
                ...
                <td>{{$nm->feature}}</td>
                <td>
                    <form action="{{route('PropertDetailsReport.destroy',$nm->id)}}" method="POST">
                        @csrf
                        @method('DELETE')
