...
<div class="nm">
    ...
    lssue Cheque From Bank :
</div>
<form action="{{route('lssueChequeFromBank.index')}}" method="post">
    @csrf
    @method('post')
    <div class="contacts">
        <div class="home">
        ...
        <div class="footer">
            ...
            <div class="mero">
                ...
                <input type="date" name="chequedate" placeholder="Cheque Data " required>
                <label for="">To</label>
                <input type="date" name="tochequedate" placeholder="To Cheque Data" required>
            </div>
            <div class="mero">
                <label for="">iSSUE</label>
                <input type="date" name="issuedate" placeholder="issuedata" required>
                <label for="">To</label>
                <input type="date" name="toissuedate" placeholder="To" required>
            </div>
            <div class="mero">
                <label for="">Print</label>
                <input type="date" name="printdatefrom" placeholder="printdateform" required>
                <label for="">To</label>
                <input type="date" name="toprintdatefrom" placeholder="toprintdateform" required>
            </div>
    ...
    <table class="table">
        ...
        @foreach ($moo as $nm )
          <tr>
            ...
            <td>{{$nm->printdatefrom}}</td>
            <td>{{$nm->toprintdatefrom}}</td>
            <td>{{$nm->printstatus}}</td>
            <td>{{$nm->company}}</td>
            <td>
                <form action="{{route('lssueChequeFromBank.destroy',$nm->id)}}" method="post">
                    @csrf
                    @method("DELETE")
