...
<form action="{{route('ContractListReport.index')}}" method="post">
    @csrf
    @method('post')
    <div class="contacts">
        <div class="home">
        ...
        <div class="footer">
            ...
            <div class="mero">
                ...
                <input type="date" name="startdateform" placeholder="Start Date From " required>
                <label for="">To</label>
                <input type="date" name="tostartdateform" placeholder="To " required>
            </div>
            <div class="mero">
                <label for="">End</label>
                <input type="date" name="enddateform" placeholder="End Date From" required>
                <label for="">To</label>
                <input type="date" name="toenddateform" placeholder="To" required>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$nm->startdateform}}</td>
                <td>{{$nm->tostartdateform}}</td>
                <td>{{$nm->enddateform}}</td>
                <td>{{$nm->toenddateform}}</td>
                <td>{{$nm->property}}</td>
                <td>{{$nm->buildingname}}</td>
                <td>{{$nm->agentbroker}}</td>
                <td>
                    <form action="{{route('ContractListReport.destroy',$nm->id)}}" method="post">
                        @csrf
                        @method('DELETE')
